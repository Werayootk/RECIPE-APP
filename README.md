...
![](https://github.com/Werayootk/RECIPE-APP/blob/main/images/recipe.gif)

This project create for practice Redux-saga skill.
...
1. Clone this repo
   ...
   ```
2. Install NPM packages in folder
   ```sh
   npm install
   ```
3. Get API key from 
...
```
4. insert your key in folder redux file `api.js`
```
...
1. In folder run `npm run start` to start client
   ```sh
   npm run start
   ```
...
This project got inspire from https://www.youtube.com/watch?v=4s2bTUbKNUs
